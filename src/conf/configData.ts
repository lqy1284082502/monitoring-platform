export const configData = [
    ...
    },
    {
        ...
        className: 'LightMapping',
        componentName: 'lightMapping',
    ...
    },
    {
        ...
        className: 'GeoJsonLoad',
        componentName: 'coordinateLoad',
    ...
    },
    {
        ...
        className: 'MapAnimation',
        componentName: 'mapAnimation',
    ...
    // 粒子动画
    {
        ...
        className: 'IonAnimation',
        componentName: 'ionAnimation',
    ...
    // 道路流光
    {
        ...
        className: 'StreamingLight',
        componentName: 'roadStreamingLight',
    ...
    // 2d 渲染
    {
        ...
        name: '2D渲染',
        path: '/item/2d-render',
        className: 'TwoDRender',
        componentName: 'twoDRender',
    ...
    // 地球扫光
    {
        ...
        className: 'EarthSweep',
        componentName: 'earthSweep',
    ...
    // 地球案例1
    {
        ...
        className: 'EarthCase1',
        componentName: 'earthCase1',
    ...
    // 相机渲染
    {
        ...
        className: 'CameraRender',
        componentName: 'cameraRender',
